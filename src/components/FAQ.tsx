...
const faqs: FAQItem[] = [
  {
    ...
    question: "How fast can rivelolabs build and deploy a production-grade AI or web platform?",
    answer:
  ...
  },
  {
    ...
    question: "What high-traffic platforms and scalable applications has rivelolabs engineered?",
    answer:
  ...
  },
  {
    ...
    answer:
      "You own 100% of all intellectual property, source code, design files, and cloud infrastructure upon project handover. Calquors Private Limited / rivelolabs signs comprehensive non-disclosure agreements (NDAs) by default and guarantees zero vendor lock-in.",
  },
  {
    category: "AI & Modern Tech Stack",
    question: "What technologies and AI frameworks does rivelolabs specialize in?",
    answer:
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-sm text-slate-600 max-w-md mx-auto">
            Everything you need to know about partnering with rivelolabs and shipping at flash speed.
          </p>
        </div>
            ...
            return (
              <div
                ...
                className={`rounded-2xl border transition-all overflow-hidden ${
                  isOpen
                    ? "border-indigo-600/30 bg-white shadow-md"
                ...
                >
                  ...
                  <div
                    className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full border transition-transform duration-300 ${
                      isOpen
                        ? "rotate-180 border-indigo-500 bg-indigo-50 text-indigo-700"
                  ...
                  {isOpen && (
                    ...
                    >
                      <div
                        ...
                        className="px-5 sm:px-6 pb-5 sm:pb-6 pt-0 text-sm sm:text-base leading-relaxed text-slate-700 border-t border-black/5 mt-1"
                      >
        ...
        {/* Footer Prompt */}
        <div className="mt-10 p-6 rounded-2xl bg-indigo-50 border border-indigo-100 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-indigo-600/10 border border-indigo-600/20 flex items-center justify-center text-indigo-700 shrink-0">
              <Mail className="w-5 h-5" />
            </div>
            <div>
              <h4 className="text-sm font-bold text-slate-900">Have a specific project in mind?</h4>
              <p className="text-xs text-slate-600">Direct inquiries to hello@rivelolabs.com or submit your specs.</p>
            </div>
          </div>
          <button
            onClick={onOpenModal}
